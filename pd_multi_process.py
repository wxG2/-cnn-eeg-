# -*- coding:utf-8 -*-
# @Author: wxG2
# @Time: 2024/8/20 上午8:49
# @File: pd_multi_process.py
import mne
import numpy as np
...
# 读取hc数据集
for i in range(15):
    data_path = '../dataset/sande_PD/pd/sub-pd'
    sub_path = '/ses-off/eeg/sub-pd'
    raw_path = data_path + str(i + 1) + sub_path + str(i + 1) + '_ses-off_task-rest_eeg.bdf'
    ...
    im_gray.save("pd_data/pd_"+str(i+1)+'.jpg', format='jpeg')